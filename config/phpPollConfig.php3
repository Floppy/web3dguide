...
$poll_baseURL = "/polls";	        // base path of script
						// NO slash at the end!

$poll_mySQL_host = "localhost";			// hostname of MySQL database
$poll_mySQL_user = "guide";			// MySQL username
$poll_mySQL_pwd = "";				// MySQL password

$poll_dbName = "guide";				// database to store the tables in

$poll_descTableName = "poll_desc";		// name of table that keeps poll descriptions
...
$poll_IPLocking = 1;				// do you want phpPolls to additionally use IP locking?
$poll_IPLockTimeout = 2419200;			// number of seconds for one IP to be locked

$poll_resultBarHeight = 20;			// height in pixels of percentage bar in result table
$poll_resultBarScale = 6;			// scale of result bar (in multiples of 100 pixels)
...
$poll_cookiePrefix = "gpoll";			// prefix for cookie names
